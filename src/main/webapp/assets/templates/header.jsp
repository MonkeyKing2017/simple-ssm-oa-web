...
<div class="header navbar navbar-inverse navbar-fixed-top">
    ...
    <div class="header-inner">
        ...
        <a class="navbar-brand" href="index.html">
            <img src="${baseResources}/img/logo.png" alt="logo" class="img-responsive" />
        </a>
        <!-- END LOGO -->
        <!-- BEGIN RESPONSIVE MENU TOGGLER -->
        <a href="javascript:;" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
            <img src="${baseResources}/img/menu-toggler.png" alt="" />
        </a>
        ...
        <ul class="nav navbar-nav pull-right">
                        ...
                        <ul class="dropdown-menu-list scroller" style="height: 250px;">
                            <li>
                                <a href="inbox.html?a=view">
                                    <span class="photo"><img src="${baseResources}/img/avatar2.jpg" alt=""/></span>
                                    <span class="subject">
                           ...
                           auctor nibh...
                            ...
                            <li>
                                <a href="inbox.html?a=view">
                                    <span class="photo"><img src="${baseResources}/img/avatar3.jpg" alt=""/></span>
                                    <span class="subject">
                           ...
                           auctor nibh...
                            ...
                            <li>
                                <a href="inbox.html?a=view">
                                    <span class="photo"><img src="${baseResources}/img/avatar1.jpg" alt=""/></span>
                                    <span class="subject">
            ...
            <li class="dropdown user">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                    <img alt="" src="${baseResources}/img/avatar1_small.jpg"/>
